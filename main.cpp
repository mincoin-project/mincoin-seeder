...
static const string mainnet_seeds[] = {"tux.mincointools.com", "tux.mincoinpool.org", "klondike.minaddress.org", ""};
static const string testnet_seeds[] = {"tux.mincointools.com", "tux.mincoinpool.org", "klondike.minaddress.org", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    ...
    db.Add(CService("jv2b2fijqdcnxfhg.onion", 9334), true);
  }
  do {
